...
To read about the details of this approach, refer to my blog post [Hiding Your Secrets](http://nayemanasir.com/secrets/).
...
implementing async/await, refer to my blog [Finishing one task before the next with Async/Await](http://nayemanasir.com/secrets/).
